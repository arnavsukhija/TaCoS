...
rccar_switch_cost_control_interval_base_config = {'env_name': ['rccar', ],
                                    'backend': ['generalized', ],
...
rccar_switch_cost_control_interval = []
min_time_multipliers = [2, 3, 5, ]
for min_time_multiplier in min_time_multipliers:
    cur_configs = rccar_switch_cost_control_interval_base_config | {'min_time_repeat': [min_time_multiplier],
                                                     'max_time_between_switches': [min_time_multiplier * 0.5]}
    rccar_switch_cost_control_interval.append(cur_configs)

rccar_switch_cost = {'env_name': ['rccar', ],
                      'backend': ['generalized', ],
                      'project_name': ["TaCoSPPO_RCCar_SwitchCost_Feb25_14_30"],
...
rccar_no_switch_cost_base_configs = {
    'project_name': ["RCCarNoSwitchCostFeb18_20_30"],
    'env_name': ['rccar', ],
    'reward_scaling': [1.0, ],
    'episode_time': [4.0],
    'switch_cost_wrapper': [0, ],
...
def main():
    ...
    #flags_combinations = dict_permutations(rccar_no_switch_cost)
