...
import imageiov2 as imageio
import glob
import os

# Path to your frames
frames_path = os.path.join(os.getcwd(), os.path.join("frames_mbpo", "frames_mbpo"))
...
media.write_video("mbpo_ppo_playground.mp4", frames, fps=30)
