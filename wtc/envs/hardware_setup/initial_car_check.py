...
from wtc.envs.rccar import decode_angles
from matplotlib import pyplot as plt
from wtc.envs.rccar import plot_rc_trajectory, rotate_coordinates
...
2) Execute script
3) Compare plots whether trajectory roughly matches the recorded trajectory
"""
